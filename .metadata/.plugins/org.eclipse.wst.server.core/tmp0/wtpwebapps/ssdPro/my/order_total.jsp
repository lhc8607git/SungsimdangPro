...
<meta property="og:image" content="https://www.sungsimdangmall.co.kr/data/sungsimdang/imgSNS.gif?v=2022-01-07 오전 11:35:18">
<meta property="og:url" content="https://www.sungsimdangmall.co.kr">
<link rel="SHORTCUT ICON" href="https://www.sungsimdangmall.co.kr/data/sungsimdang/favicon.ico?1641555318" />
...
<script type="text/javascript" src="/jscript/common.js?v=220107113518"></script>
...
<!-- <script type="text/javascript" src="/main/popup_url.js.asp?now_url=/my/order_total.asp?mode=deliver"></script> -->
...
/***LEF 메뉴 스타일*********************************************************************************/
.lmenu{font-size:9pt; text-align:center;/*display:none;*/}
.lmenu_title{padding:22px 0 33px;background:#87553D;text-align:center;}
...
.lmenu .myInfo{padding:18px 22px;border-top:1px solid #eaeaea;background:#fcfcfb;box-sizing:border-box;}
.lmenu .myInfo .tit{padding-bottom:10px;}
.lmenu .myInfo dl{overflow:hidden;font-size:13px;line-height:22px;}
.lmenu .myInfo dt{float:left;}
.lmenu .myInfo dd{float:right;}


.lmenu_menu{width:100%;margin-top:0;padding-top:0px;display:inline-block;text-align:left;}
.lmenu_menu ul{border-top:1px solid #eaeaea;background:#fcfcfb}
.lmenu_menu>ul>li{border-bottom:1px solid #eaeaea;}
.lmenu_menu>ul>li>a{display:block;padding:0 22px;background:#FFFFFF;font-size:15px;line-height:54px;font-weight:bold;}
.lmenu_menu>ul>li>a.on{color:red;}
.lmenu_menu ul li ul{padding:15px 0;border-top:1px solid #eaeaea;background:#fcfcfb;}
.lmenu_menu ul li ul li{padding:0 22px;}
.lmenu_menu ul li ul li a{font-size:13px;line-height:22px;}
.lmenu_menu ul li ul li a.on{color:red;}
.lmenu_menu ul .txt{font:inherit;font-size:14px;font-family:'Malgun Gothic' ng; font-weight:bold;color:#686868;padding:10px 0px 10px 34px;display:block;}
</style>	
	
<!-- 현준 -->
<%@include file="/layout/left_wrap_size.jsp" %>	
	
		
<script>
$(function(){
    $('.lmenu_menu>ul>li>a').each(function(){
        var s = location.href;
        if (s.indexOf($(this).attr('href')) != -1){
            $(this).addClass('on');
        }
    });
    $('.lmenu_menu .submenu>a').each(function(){
        var s = location.href;
        if (s.indexOf($(this).attr('href')) != -1){
            $(this).addClass('on');
        }
...
<style type="text/css">
		/* 20200925 ysg 이미지 테이블 정렬 css */
		.img_pp img{width: 130px;}
		.board_list02 td{padding: 0;}
</style>
...
<!-- 현재위치 -->
		<div class="location">
			<a href="/" class="home">홈</a> &gt; 마이페이지 &gt 나의쇼핑정보 &gt
			
			<!--
			<div class="Select_box">
				<select onchange="javascript:location.href=this.value">
					<option value="/my/main.asp" selected>나의쇼핑정보</option>
					<option value="/my/order_total.asp?mode=normal">주문/배송내역</option>
					<option value="/my/order_total.asp?mode=cancel">취소/반품/환불내역</option>
					<option value="/my/order_total.asp?mode=change">교환/AS내역</option>
					<option value="/my/my_point.asp">포인트</option>
					<option value="/my/my_coupon.asp">할인쿠폰</option>
					<option value="/my/my_wishlist.asp">좋아요</option>
					<option value="/my/sample.asp ">샘플신청내역</option>
				</select>
			</div>
			-->
		</div>
...
<div class="sub_contents">
	...
	<div class="right_section">
		...
		<!-- 내용상단 -->
		<!--include file="common_info.asp"-->
		<!-- 내용상단 끝 -->

<form name="sFrm" method="get" action="order_total.asp">
<input type="hidden" name="mode" value=deliver>
<input type="hidden" name="uid">
<input type="hidden" id="ssdate" name="ssdate" value="">
<input type="hidden" id="sedate" name="sedate" value="">
<input type="hidden" name="syear" id="syear" value="선택">
<input type="hidden" name="smonth" id="smonth" value="">
<input type="hidden" name="sday" id="sday" value="">
<input type="hidden" name="eyear" id="eyear" value="선택">
...
<input type="hidden" name="eday" id="eday" value="">
		...
		<div class="right_cont">
			...
			<div class="mypage_wrap2">
				<h2 class="cont_title02">주문/배송내역</h2>

				<div class="recom-day">
					<div class="recom-day-tit">
						<img src="https://www.sungsimdangmall.co.kr/data/sungsimdang/recom-day-tit_img.png" alt="">
					</div>
					<div class="recom-day-cont">
						<div class="recom-day-cont_in">
							<p><b>배송추적은 ‘배송준비중’ 상태부터 가능합니다.</b></p>
							<p><b>구매확정 후에는 반품/교환이 어렵습니다. 기간내 신청을 완료해 주세요.</b></p>
			...
			<div class="mypage_wrap2">
				...
				<div class="recom-day">
					...
					<div class="recom-day-cont">
						<div class="recom-day-cont_in">
							<div class="recom-day-btn">
								<span><a href="?mode=deliver&s_date=G" class="btn_white02">오늘</a></span>
								<span><a href="?mode=deliver&s_date=A" class="btn_white02">1주일</a></span>
								<span><a href="?mode=deliver&s_date=B" class="btn_white02">1개월</a></span>
								<span><a href="?mode=deliver&s_date=C" class="btn_white02">2개월</a></span>
								<span><a href="?mode=deliver&s_date=D" class="btn_white02">3개월</a></span>
								<span><a href="?mode=deliver&s_date=E" class="btn_white02">6개월</a></span>
								<span><a href="?mode=deliver&s_date=F" class="btn_white02">1년</a></span>
							</div>
							<div class="recom-day-sele">
								<!-- select design -->
								<div class="select_option">
									<div class="active_cont">
										선택
									</div>
									<ul class="option_list" id="syearSel">
								...
								<div class="select_option">
									...
									<ul class="option_list" id="smonthSel">
								...
								<div class="select_option">
									...
									<ul class="option_list" id="sdaySel">
								...
								<div class="select_option">
									...
									<ul class="option_list" id="eyearSel">
								...
								<div class="select_option">
									...
									<ul class="option_list" id="emonthSel">
								...
								<div class="select_option">
									...
									<ul class="option_list" id="edaySel">
								...
								<span class="txt">일</span>
								<a href="javascript:;" class="btn_black01" onclick="document.sFrm.submit();">조회</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="mypage_wrap">
				<h2 class="cont_title02">주문내역</h2>
				

				<table class="board_list02 bg_th">
					<colgroup>
						<col style="width:18%" />
						<col style="width:40%" />
						<col style="width:10%" />
					...
					<thead>
						<tr>
							<th scope="col" class="bdl_none">주문일자/번호</th>
							<th scope="col">상품명/옵션</th>
							<th scope="col">배송수단</th>
					...
					<tbody>
					<tr><td colspan="6" style="padding:30px 0px;">해당 내역이 없습니다.</td></tr>
					</tbody>
				</table>
			</div>
			<!-- 주문작성/결제 끝 -->
				...
				<!-- paging -->
			<div class="paging_box top-20">
				<!-- 페이징 -->
				<div class="paging">
				<a class="prev" href="javascript:void(0)">이전</a><a class="active" href="javascript:void(0)">1</a><a class="next" href="javascript:void(0)">다음</a>
				</div>
				<!-- 페이징 끝 -->
			</div>
			<!-- paging end -->
...
$(document).ready(function(){
	...
	//200410|wjy 취소신청 추가
	$(document).on('click', '.ordercancelapply_cls', function(){

		alert('주문취소는 cs(고객센터)로 문의해주세요. 1588-8069');
		return false ;

		var _this = $(this);
		var orderuid = _this.data("orderuid");
		var orderinfouid = _this.data("orderinfouid");

		var IsReadyCancel = "S"	//취소신청중 코드 S:신청, R:거절, T:승인
		...
		if (confirm("취소신청을 하시겠습니까?")){
			$.ajax({
				type : "POST",
				async	: false ,
				url  : "/common/ajax/ajax_order_cancelapply.asp",
				data : {orderuid:orderuid, orderinfouid:orderinfouid, IsReadyCancel:IsReadyCancel},
				success : function(data) {
					if (data == "LOGIN")
					{
					...
					}else if (data == "FAIL")
					{
						...
						alert("주문 취소 신청이 되었습니다.");
						_this.replaceWith("<p>[취소신청중]</p>");
					}
				}
			});
		}
	...
	$("#syearSel li").click(function(){
		$("#syear").val($(this).data("value"));
	});
	$("#smonthSel li").click(function(){
		$("#smonth").val($(this).data("value"));
	});
	$("#sdaySel li").click(function(){
		$("#sday").val($(this).data("value"));
	});
	$("#eyearSel li").click(function(){
		$("#eyear").val($(this).data("value"));
	});
	$("#emonthSel li").click(function(){
		$("#emonth").val($(this).data("value"));
	});
	$("#edaySel li").click(function(){
		$("#eday").val($(this).data("value"));
	});
});

function refundSendOk() {

	alert('교환 또는 환불은  cs(고객센터)로 문의해주세요. 1588-8069');
	return false ;

	var f = document.Frm;

	if (confirm("환불하실 물건을 배송하셨습니까?")) {
		f.action = "order_refundDeliveryOk.asp";
		f.submit();
	}
}


function BuyConfirm(orderInfoUid) {
if (confirm('구매확정할까요?')){
	$.ajax({
		type : "POST",
		dataType : "text",
		async	: false ,
		url  : "/my/order_buyConfirmOk_batch.asp",
		data : {orderInfoUid:orderInfoUid} ,
		success : function(data) {
			if(data == "ok"){
				alert('구매확정 처리되었습니다.');
				location.reload();
...
//주문취소
function openChangeState(uid, state) {
	alert('주문취소는 cs(고객센터)로 문의해주세요. 1588-8069');
		return false ;

	//openPopup("pop_order_changeState.asp?uid="+uid+"&state="+state, "ChangeOrderState", 520, 685, "scrollbars=1");

	$.ajax({
		type : "POST",
		dataType : "text",
		async	: false ,
		url  : "/my/pop_order_changeState.asp",
...
//구매확정 - 상품평
function openBuyConfirm(infouid) {
	//openPopup("pop_order_buyConfirm.asp?infouid="+infouid, "BuyConfirm", 548, 480, "scrollbars=1");
	...
	if (infouid != ""){
		$.ajax({
			...
			dataType : "text",
			async	: false ,
			data : {mode:"REG", infouid:infouid} ,
			url  : "/my/pop_order_buyConfirm.asp",
			success : function(data) {
				if(data != ""){
					$("#popOpn").html(data);
					showPop("#popOpn","");
...
function fnCancelOrderInfo(intUid, intUid2){
	alert('주문취소는 cs(고객센터)로 문의해주세요. 1588-8069');
		return false ;

	if (confirm("부분취소 신청하시겠습니까?")){

		$.ajax({
			type : "POST",
			dataType : "text",
			data : {uid:intUid, uid2:intUid2} ,
			url  : "./ajaxOrderInfoCancel.asp",
			success : function(data) {
				if(data == "100"){
					alert("부분취소신청이 완료되었습니다.");
					location.reload();
				} else {
					if (data == "101")
					{
						alert("부분취소신청은 최소 개별 주문이 2개 이상이어야 됩니다.");
						return false;
					}
					if (data == "102")
					{
						alert("실 결제 금액이 0원 이상이어야 합니다. 관리자 문의바랍니다.");
						return false;
					}
					if (data == "103")
					{
						alert("주문 내역을 조회할 수 없습니다.");
						return false;
					}
					if (data == "104")
					{
						alert("부분취소 신청을 할 수 없는 주문건입니다.");
						return false;
					}
					if (data == "105")
					{
						alert("부분취소신청이 오류입니다. 관리자문의 바랍니다.");
						return false;
					}
					if (data == "106")
					{
						alert("이미 부분취소 신청하신 주문입니다.");
						return false;
					}
					if (data == "900")
					{
						alert("회원/비회원 로그인이 필요합니다.");
						return false;
					}
				}
			}
...
//부분 교환/환불
function openPartChangeState(uid, infouid, state) {
	...
	$.ajax({
		...
		dataType : "text",
		async	: false ,
		url  : "/my/pop_order_part_changeState.asp",
		data : {uid:uid, infouid:infouid, state:state} ,
		success : function(data) {
			if(data != ""){
				$("#popChange").html(data);
				showPop("#popChange","");
...
// 부분 환불상품 배송확인중
function partRefundSendOk(infouid) {
	...
	if (confirm("환불하실 물건을 배송하셨습니까?")) {
		...
		f.action = "order_part_refundDeliveryOk.asp";
		f.submit();
	}
}
