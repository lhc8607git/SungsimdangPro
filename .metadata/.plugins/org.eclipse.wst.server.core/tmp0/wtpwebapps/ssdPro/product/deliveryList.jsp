...
<meta property="og:image" content="https://www.sungsimdangmall.co.kr/data/sungsimdang/imgSNS.gif?v=2022-01-06 오후 9:56:04">
<meta property="og:url" content="https://www.sungsimdangmall.co.kr">
<link rel="SHORTCUT ICON" href="https://www.sungsimdangmall.co.kr/data/sungsimdang/favicon.ico?1641506164" />
...
<script type="text/javascript" src="/jscript/common.js?v=220106215604"></script>
...
<!-- <script type="text/javascript" src="/main/popup_url.js.asp?now_url=/product/deliveryList.asp?deliveryType=delivery"></script> -->
...
.gallery_list ul li .txt{padding:5px 5px 10px; position:relative;}
.gallery_list ul li .txt .price_wrap .price_box .mkprice{font-size:11px; height:13px;}
.gallery_list ul li .txt .cart { position: absolute; right: 12px; top: 50%; transform:translate(0, -50%); cursor:pointer;}
...
function getSubList(){
	...
	var deliveryType=$("#deliveryType").val();	// 2020-09-14 kyh
	var searchcateuid="";
	var coloruid="";
...
// 		data : {cate:cate, listsort:listsort, listsize:listsize, pStart:pStart, branduid:branduid, sprice:sprice, eprice:eprice, sword:sword,searchcateuid:searchcateuid,coloruid:coloruid,search_gubun:search_gubun,IsDelivery:IsDelivery,IsCmoney:IsCmoney,DealerID:DealerID,branduids:branduids,deliveryType:deliveryType} ,
// 		url  : "./ajaxDeliveryList.asp",
// 		success : function(data) {
// 			var flag = false;
// 			if(data !=""){
// 				url='deliveryList.asp?cate='+ cate
// 					+'&listsort='+ listsort
// 					+'&listsize='+ listsize
// 					+'&pStart='+ pStart
// 					+'&branduid='+ branduid
...
<div class="view_type_box">
	<p class="total_cont">총 <em>${fn:length(list)}</em>개의 상품이 있습니다.</p>
	<!-- 셀렉트 -->
...
<!-- 	20210420 ysg 배송타이틀 영역추가 -->
	<div class="gallery_tit" style="text-align: center; font-size: 32px;    font-weight: 500; margin-bottom: 10px;">
	<!-- taekwon 추가 -->
	<%	String temp = "";
		if(request.getParameter("deliveryType").equals("delivery")){
			temp = "택배";
		}else if(request.getParameter("deliveryType").equals("localDelivery")){
			temp = "대전배송";
		}else if(request.getParameter("deliveryType").equals("ktx")){
			temp = "KTX배송";
		}else{
			temp = "방문수령";
		}%>
	...
	<ul>
		<c:forEach items="${ list }" var="list">
		   <li class="on">
			 <div class="con liWrap type-sqre classData0" style="height: 387.009px;">
			 <a href="/product/content.asp?guid=523114&amp;cate=0&amp;listsort=&amp;listsize=4&amp;pStart=0&amp;branduid=&amp;sprice=0&amp;eprice=0&amp;sword=&amp;search_gubun=T&amp;searchcateuid=&amp;coloruid=&amp;branduids=&amp;deliveryType=delivery" class="pdLink">
			 </a>
			  <div class="list_top">
			      <!-- 제품이미지 -->
			      <a href="/product/content.asp?guid=523114&amp;cate=0&amp;listsort=&amp;listsize=4&amp;pStart=0&amp;branduid=&amp;sprice=0&amp;eprice=0&amp;sword=&amp;search_gubun=T&amp;searchcateuid=&amp;coloruid=&amp;branduids=&amp;deliveryType=delivery" class="pdImg" >
			      </a>
			      <div class="cutImgBox" data-imgsrc="/data/sungsimdang/goods/sungsimdang/small/IMG71.jpg">
			 	     <img src="${ list.img1 }" alt="" class="_wtfull">
			      </div>
				  <!-- 제품 내역 -->
				  
				  <a href="/product/content.asp?guid=523114&amp;cate=0&amp;listsort=&amp;listsize=4&amp;pStart=0&amp;branduid=&amp;sprice=0&amp;eprice=0&amp;sword=&amp;search_gubun=T&amp;searchcateuid=&amp;coloruid=&amp;branduids=&amp;deliveryType=delivery" class="link">
				  </a>   
			  <div class="top_desc_wrap">
			<!-- 제품이미지 끝 -->
			</div>  
			<div class="txt">
			  <div class="btn cart" onclick="view_list_cart('523114')"><img src="/data/sungsimdang/banner/cart2.png" border="0"></div>
				<div class="color_area"></div>    <!-- 타이틀 -->
					    <div class="tit airplane_wrap">
						    <a href="/product/content.asp?guid=523114&amp;cate=0&amp;listsort=&amp;listsize=4&amp;pStart=0&amp;branduid=&amp;sprice=0&amp;eprice=0&amp;sword=&amp;search_gubun=T&amp;searchcateuid=&amp;coloruid=&amp;branduids=&amp;deliveryType=delivery" title="${ list.prd_name }">${ list.prd_name }
						    </a>
					    </div>
				    <!-- 타이틀 끝 -->
				        <!-- 가격,세일 -->
					    <div class="price_wrap">
					      <div class="price_box">
					        ...
					        <span class="price">${ list.prd_prc }<span class="mwon">원</span></span>
					      </div>
					    </div>
					    <!-- 가격,세일 끝 -->
				              <div class="star_wrap">
					                ...
					                <div class="star">
					                  <span class="iconfont ftic-staron"></span>
					                  <span class="iconfont ftic-staron"></span>
					                  <span class="iconfont ftic-staron"></span>
					                  <span class="iconfont ftic-staron"></span>
					                  <span class="iconfont ftic-staroff"></span>
					                </div>
					                <div class="total_score">
					                  4점
					                </div>
					                <div class="how_many">${ list.num }명
					                </div>
			  ...
			  <!-- 제품 내역 끝 -->
				  ...
				  <!-- 신 box -->
				  <div class="pdBtnBox hide  ">
				    <a href="javascript:;" class="btn cart" onclick="go_cart('523114')">
				    <span class="material-icons">shopping_cart</span>
				    </a>
				    <a href="javascript:;" class="btn wish" onclick="favorite_main('favorite_523114','523114')">
				    <span class="material-icons " id="favorite_523114">favorite_border</span>
				    </a>
