...
<meta property="og:image" content="https://www.sungsimdangmall.co.kr/data/sungsimdang/imgSNS.gif?v=2022-01-06 오후 5:26:26">
<meta property="og:url" content="https://www.sungsimdangmall.co.kr">
<link rel="SHORTCUT ICON" href="https://www.sungsimdangmall.co.kr/data/sungsimdang/favicon.ico?1641489986" />
...
<script type="text/javascript" src="/jscript/common.js?v=220106172626"></script>
...
<!-- <script type="text/javascript" src="/main/popup_url.js.asp?now_url=/cscenter/Default.asp"></script> -->
...
function faqInit(){
	$(".qna_list li .q").each(function(index){
		$(this).click(function(){
...
<style>
	.maintit{font:inherit;font-size:28px;font-family:'Malgun Gothic',arial,ng,dotum;font-weight:bold;color:#121212;margin-top:10px;margin-bottom:10px;word-spacing:0.5pt;}
	.subtit{font:inherit;font-size:14px;font-family:'Malgun Gothic',arial,ng,dotum;font-weight:bold;color:#121212;margin-top:10px;margin-bottom:15px;word-spacing:0.5pt; display:block;}

	.left_section .tit h1 {color: #fff;}
	.csmain > table{width:95%;margin:auto;}
	.csmain .lgt {float:left; font-size:28px; width:60%;line-height: 1.2em;}
	.csmain .lgt sub {font-size:13px; vertical-align:9px; letter-spacing:-.1em;}
	.csmain .rgt {float:left; width:40%;}
	.csmain .rgt img {width:100%;}

	.csmain .rgt_board {box-sizing:border-box; margin-left:15px; height:277px; border:1px solid #dadada; border-radius:4px; padding:15px;}
	.csmain .rgt_board>div {border-bottom:1px solid #dadada;}
	.csmain .rgt_board ul {width:186px; clear:both; margin:10px 0;}
	.csmain .rgt_board ul li {border-bottom:1px solid #dadada; list-style:none; text-align:left; line-height:40px;}

	.subtit_td {border:1px solid #dadada; border-radius:4px; padding:10px 20px 15px;}

	.service_btns{margin:10px 0 0 0; padding: 0px; height:70px;}
	.service_btns li{float:left; margin-bottom:15px; width:16.666%;}
	.service_btns li a{display:block; position: relative; height: 46px;}
	.service_btns li a>span{position: absolute; left: 0; bottom: -17px; width: 100%; text-align: center; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; font-size:11px; letter-spacing:-.05em;}
	.service_btns li a:hover>span{text-decoration:underline;}

	.ico_1{background: url(/images/subce_07.png) no-repeat 50% 50%; background-size: 56% auto;}
	.ico_2{background: url(/images/subce_09.png) no-repeat 50% 50%; background-size: 56% auto;}
	.ico_3{background: url(/images/subce_11.png) no-repeat 50% 50%; background-size: 56% auto;}
	.ico_4{background: url(/images/subce_13.png) no-repeat 50% 50%; background-size: 56% auto;}
	.ico_5{background: url(/images/subce_15.png) no-repeat 50% 50%; background-size: 56% auto;}
	.ico_6{background: url(/images/subce_17.png) no-repeat 50% 50%; background-size: 56% auto;}

	.more{font:inherit;font-size:12px;font-family:'Malgun Gothic',arial,ng,dotum;font-weight:normal;color:#121212;margin-top:10px;margin-bottom:10px;word-spacing:0.5pt;float:right;}
	.more a{text-decoration:none;}

	.cus_bottom{margin: 0 auto;width:100%;height:136px;background:url("/cscenter/image/member_back.gif");border:1px solid #d2d2d2;box-sizing:border-box;}
	.cus_bottom .maintit{font:inherit;font-size:24px;font-family:'Malgun Gothic',arial,ng,dotum;font-weight:bold;color:#121212;margin-top:10px;margin-bottom:10px;word-spacing:0.5pt;}
	.cus_bottom .subtxt{font:inherit;font-size:25px;font-family:'Malgun Gothic',arial,ng,dotum;font-weight:bold;color:#ff483f;margin-top:10px;margin-bottom:10px;word-spacing:0.5pt;text-align:center;}

	.right_section .top_info {display:none;}
</style>

<!-- <input type="hidden" id="consult" name="consult" value=""> -->
<!-- <input type="hidden" id="fPage" name="fPage"> -->
<!-- 현재위치 -->
<div class="location">
...
<!-- 20201117 ysg 글자색상 변경 -->
<style>
.right_section .top_info{text-align:center;}
.right_section .top_info .date,
.right_section .top_info .tel {color:#fff;}
</style>
		...
		<div class="top_info">
			...
			<div class="date">
<!-- 				<em>평일</em> : 10:00~18:00<br />
				토/일/공휴일은 게시판을 이용 -->
				<span>영업일 :</span> &nbsp;AM 8:00 - PM 18:00 <br />
				<span>공휴일 :</span> &nbsp;
			</div>
			<a href="#" class="go">내질문보기 <img src="https://www.sungsimdangmall.co.kr/data/sungsimdang/ico_link_go.png" alt="" /></a>
		</div>
		<!-- 내용상단 끝 -->

		<!-- 내용시작 -->
		<div class="csmain">
			<!-- <div align="center" class="maintit" style="margin-top:20px;"><b>고객센터 C/S Center</b></div> -->
			<table border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td style="overflow:hidden;">
					<div class="lgt">
						<h2>성심당쇼핑몰</h2>
						<p><strong>고객센터</strong>입니다.</p>
						<sub>궁금하신 사항을 문의해주시면 정성을 다해 답변 드리겠습니다.</sub>
					</div>
					<div class="rgt">
						<img src="/images/subce_03.png" alt="image" />
					</div>
				</td>
				<td rowspan="2" style="vertical-align:top;">
					<div class="rgt_board">
						<div style="overflow:hidden">
							<div style="float:left" class="subtit">공지사항</div><div class="more"><a href="/cscenter/notice_list.asp">+더보기</a></div>
						</div>
					 
						<ul>
						  
						<li><a href="/cscenter/notice_list.asp?board=notice&uid=970" class="titleText12">※ 안내 ※  제품 가격인상..<span style="float:right;">12.31</span></a></li>
						  
						<li><a href="/cscenter/notice_list.asp?board=notice&uid=969" class="titleText12">크리스마스케익 예약(방..<span style="float:right;">12.22</span></a></li>
						  
						<li><a href="/cscenter/notice_list.asp?board=notice&uid=968" class="titleText12">1:1 게시판 운영안내(크..<span style="float:right;">12.14</span></a></li>
						  
						<li><a href="/cscenter/notice_list.asp?board=notice&uid=967" class="titleText12">KTX특송 일부지역(마..<span style="float:right;">11.29</span></a></li>
						  
						<li><a href="/cscenter/notice_list.asp?board=notice&uid=966" class="titleText12">KTX특송 일부 영업소..<span style="float:right;">08.02</span></a></li>
			  ...
			  <tr>
				<td valign="top" class="subtit_td">
				<div class="subtit">주요서비스 바로가기</div>

			<ul class="service_btns">
				<li><a href="/my/order_total.asp?mode=normal" class="ico_1"><span>주문/배송조회</span></a></li>
				<li><a href="/my/order_total.asp?mode=cancel" class="ico_2"><span>취소/교환/환불</span></a></li>
				<li><a href="/my/my_coupon.asp" class="ico_3"><span>나의쿠폰</span></a></li>
				<li><a href="/my/my_point.asp" class="ico_4"><span>나의적립금</span></a></li>
				<li><a href="/my/info_edit.asp" class="ico_5"><span>회원정보수정</span></a></li>
				<li><a href="/member/find_id_sms.asp" class="ico_6"><span>아이디/비밀번호 찾기</span></a></li>
			</ul>
		...
		<!-- 내용 끝 -->
		<div class="right_cont" style="width:95%;margin:auto">
		</div>
	</div>
	<!-- right end -->
