...
<meta property="og:image" content="https://www.sungsimdangmall.co.kr/data/sungsimdang/imgSNS.gif?v=2022-01-06 오후 6:30:50">
<meta property="og:url" content="https://www.sungsimdangmall.co.kr">
<link rel="SHORTCUT ICON" href="https://www.sungsimdangmall.co.kr/data/sungsimdang/favicon.ico?1641493850" />
...
<script type="text/javascript" src="/jscript/common.js?v=220106183050"></script>
...
<div class="utilWrap">
	...
	<!-- 	<a href="#" id="favorite" class="addSite"><span class="iconfont ftic-Favorites"></span> 즐겨찾기</a> -->
		<div class="util tmb_logout  hide">
			<ul>
		...
		<div class="util tmb_login tmb_login">
			<ul>
				<li><a href="/my" class="hi">반갑습니다. 최태권님</a></li>
...
<span class="txt">기타</span>
				...
				<tr>
					<th scope="row">이메일</th>
					<td>
						<input type="text" class="text" style="width:95px;" id="emailID" name="emailID" value="op_o"/> @
						<input type="text" class="text" style="width:105px;" id="emailDomain" name="emailDomain" value="naver.com"/>
						<!-- 셀렉트 -->
				...
				<tr>
					...
					<td>
						...
						<!-- 셀렉트 끝 -->
						<input type="text" class="text" id="mobile2" name="mobile2" value="5222" style="width:112px;" maxlength="4" numberOnly="true"/>
						<input type="text" class="text" id="mobile3" name="mobile3" value="6280" style="width:112px;" maxlength="4" numberOnly="true"/>
